			...
			<div class="panel panel-primary col-sm-6 col-sm-offset-3">
					...
					<form role="form" action="LoginForm" method="POST">
						...
						<div class="form-group">
							...
							<a href="/Bullhorn/RegisterUser.jsp"class="btn btn-primary">New User Registration</a>
						</div>

					</form>
					<a href="ServletViewPosts?guestUser=yes" class="btn btn-primary">Guest Account</a> <br><br>
				</div>
			</div>
</body>
</html>